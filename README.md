...
- **For project status, decisions, and history**: see the vault project page at `Open-Memory-Vault/projects/OS-000-SEO/README.md`.

## Quick facts

- **Project code**: OS-000-SEO
- **Created**: 2026-07-03
- **GitHub**: https://github.com/parrysan/OS-000-SEO
